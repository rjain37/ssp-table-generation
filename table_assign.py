    ...
    def ignore():
        ...
        for i in range(len(table_list)):
            for j in range(len(table_list[i])):
                if(table_list[i][j] == num1):
                    Gy = i
                    Gx = j
                elif(table_list[i][j] == num2):
                    Ry = i
                    Rx = j
        if(Gx != 0):
            holder = table_list[Gy][0]
            table_list[Gy][0] = table_list[Ry][Rx]
            table_list[Ry][Rx] = holder
        else:
            holder = table_list[Gy][1]
            table_list[Gy][1] = table_list[Ry][Rx]
            table_list[Ry][Rx] = holder
    ignore()
